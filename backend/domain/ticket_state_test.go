...
func TestCanTransition(t *testing.T) {
	tests := []struct {
		...
		{"assigned to halted", models.StatusAssigned, models.StatusHalted, true},
		{"assigned to closed", models.StatusAssigned, models.StatusClosed, true},
		{"in progress to halted", models.StatusInProgress, models.StatusHalted, true},
		...
		{"halted to in progress", models.StatusHalted, models.StatusInProgress, true},
		{"halted to closed", models.StatusHalted, models.StatusClosed, true},
		{"halted to assigned", models.StatusHalted, models.StatusAssigned, false},
